...
#-----------------------------2.1 Experiment 2------------------------#
#---------------------------------------------------------------------#
# 1. Given an N, solve for the stable point values under a set of xD and xC
helper = function(x){
...
# 2. Given an N, iterate through the parameter range of xD\xC to solve for stable star values
...
#------------------------------------------------------------------------------#
#-----------------------------2.2 Experiment 2 (beta)--------------------------#
#------------------------------------------------------------------------------#
# 3. Given an N, solve for the stable point values under a set of xD and xC (with beta)
...
# 4. Given an N, iterate through the parameter range of xD\xC to solve for stable star values (with beta)
get_star_by_N_beta = function(N){
  all = data.frame()
