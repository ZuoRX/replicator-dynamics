...
# Visualization of the first plot: xD & xC
df1 <- df %>% 
...
# Visualization of the second plot: xD & xL
df1 <- df %>% 
  subset(xDstar > 0 & xCstar == 0 & xLstar > 0) 
...
# # Visualization of the third plot: xC & xL
# df1 <- df %>% 
#   subset(xDstar == 0 & xCstar > 0 & xLstar > 0) 
# 
# p1 <- df1 %>% 
...
#------------------------------------------------------------------------#
#------------------------- Experiment 2 Visualization (beta) ------------#
#------------------------------------------------------------------------#
...
# Visualization of the first plot: xD & xC (beta)
df1 <- df %>% 
  subset(xDstar > 0 & xCstar > 0 & xLstar == 0) 
...
# Visualization of the second plot: xD & xL (beta)
df1 <- df %>% 
  subset(xDstar > 0 & xCstar == 0 & xLstar > 0) 
