...
# 1. Given an M, solve for the stable point values under a set of xD and xC
helper = function(x){
...
# 2. Given an M, iterate through the parameter range of xD\xC to solve for stable star values
...
#------------------------------------------------------------------------------#
# 3. Given an M, solve for the stable point values under a set of xD and xC (with beta)
...
# 4. Given an M, iterate through the parameter range of xD\xC to solve for stable star values (with beta)
