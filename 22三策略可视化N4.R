...
for(i in 1:nrow(parameters)){
  temp<-duplicate_dynamics3(xD=parameters$xD[i],xC=parameters$xC[i],
                            N=4,M=15,betaD=1.5,betaC=1.1,d=4,c=1,l=0.5) 
...
p1
htmlwidgets::saveWidget(as_widget(p1), "Exp1N4/M15-p1.html")
...
p2
htmlwidgets::saveWidget(as_widget(p2), "Exp1N4/M15-p2.html")
...
p3
htmlwidgets::saveWidget(as_widget(p3), "Exp1N4/M15-p3.html")
...
htmlwidgets::saveWidget(as_widget(p4), "Exp1N4/M15-p4.html")
...
for(i in 1:nrow(parameters)){
  temp<-duplicate_dynamics3(xD=parameters$xD[i],xC=parameters$xC[i],
                            N=4,M=10,betaD=1.5,betaC=1.1,d=4,c=1,l=0.5) 
...
p1
htmlwidgets::saveWidget(as_widget(p1), "Exp1N4/M10-p1.html")
...
p2
htmlwidgets::saveWidget(as_widget(p2), "Exp1N4/M10-p2.html")
...
p3
htmlwidgets::saveWidget(as_widget(p3), "Exp1N4/M10-p3.html")
...
htmlwidgets::saveWidget(as_widget(p4), "Exp1N4/M10-p4.html")
...
for(i in 1:nrow(parameters)){
  temp<-duplicate_dynamics3(xD=parameters$xD[i],xC=parameters$xC[i],
                            N=4,M=5,betaD=1.5,betaC=1.1,d=4,c=1,l=0.5) 
...
p1
htmlwidgets::saveWidget(as_widget(p1), "Exp1N4/M5-p1.html")
...
p2
htmlwidgets::saveWidget(as_widget(p2), "Exp1N4/M5-p2.html")
...
p3
htmlwidgets::saveWidget(as_widget(p3), "Exp1N4/M5-p3.html")
...
htmlwidgets::saveWidget(as_widget(p4), "Exp1N4/M5-p4.html")
